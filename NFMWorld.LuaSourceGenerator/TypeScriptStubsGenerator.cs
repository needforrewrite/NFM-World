...
//         {
//             var docParams = m.Parameters;
//             var paramStr = string.Join(", ", docParams.Select(p => $"{TsParamName(p)}: {ToTSTypeName(p.TypeName)}"));
//             sb.AppendLine($"    {m.FullLuaName}({paramStr}): {ToTSTypeName(m.ReturnTypeName)};");
//         }
//
//         // Static properties
...
//         {
//             var paramStr = string.Join(", ", m.Parameters.Select(p => $"{TsParamName(p)}: {ToTSTypeName(p.TypeName)}"));
//             sb.AppendLine($"    static {m.FullLuaName}({paramStr}): {ToTSTypeName(m.ReturnTypeName)};");
//         }
//
//         sb.AppendLine("}");
//         return sb.ToString();
