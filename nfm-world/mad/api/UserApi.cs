...
{
    public static async Task<(HttpStatusCode, ApiResponse?)> CreateLocalAccount(string username, string password)
    {
        const string route = "create_account";
    ...
    {
        const string route = "discord/create_account";
    ...
    {
        const string route = "discord/login";
