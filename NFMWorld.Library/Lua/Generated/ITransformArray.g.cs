...
public unsafe partial class LuaBindings
{
    ...
    {
        RegisterMetatable<nfm_world_library.mad.ITransform[]>("MT_ITransformArray");
        ...
        // Create type table for ArrayOfITransform
        lua_newtable(L);
    ...
    private static int ITransformArray__index(lua_State L)
    {
        ...
        if (lua_type(L, 2) == LUA_TNUMBER)
        {
            ...
            {
                var element = (obj as nfm_world_library.mad.ITransform[])![index];
                PushValue(L, element);
                return 1;
            }
            lua_pushnil(L);
        ...
        {
            case "length":
                PushValue(L, ((nfm_world_library.mad.ITransform[])obj).Length);
                return 1;
            case "longLength":
                PushValue(L, ((nfm_world_library.mad.ITransform[])obj).LongLength);
                return 1;
            case "rank":
                PushValue(L, ((nfm_world_library.mad.ITransform[])obj).Rank);
                return 1;
            case "syncRoot":
                PushValue(L, ((nfm_world_library.mad.ITransform[])obj).SyncRoot);
                return 1;
            case "isReadOnly":
                PushValue(L, ((nfm_world_library.mad.ITransform[])obj).IsReadOnly);
                return 1;
            case "isFixedSize":
                PushValue(L, ((nfm_world_library.mad.ITransform[])obj).IsFixedSize);
                return 1;
            case "isSynchronized":
                PushValue(L, ((nfm_world_library.mad.ITransform[])obj).IsSynchronized);
                return 1;
            case "count":
    ...
    private static int ITransformArray__newindex(lua_State L)
    {
        ...
        if (lua_type(L, 2) == LUA_TNUMBER)
        {
            ...
            if (index >= 0 && index < (obj as System.Array)!.Length)
            {
                ...
                (obj as nfm_world_library.mad.ITransform[])![index] = value;
            }
            return 0;
        }
    ...
    private static int ITransformArray_new(lua_State L)
    {
        ...
        var array = new nfm_world_library.mad.ITransform[dim0];
        PushObject(L, array, "MT_ITransformArray");
        return 1;
    }
