...
{
    // =========== Bindings for IEnumerator`1 (IEnumerator_Quaternion) ===========
    private static void Register_IEnumerator_Quaternion(lua_State L)
    {
        RegisterMetatable<System.Collections.Generic.IEnumerator<Stride.Core.Mathematics.Quaternion>>("MT_IEnumerator_Quaternion");

        // Create metatable for instances
        luaL_newmetatable(L, "MT_IEnumerator_Quaternion");

        // __gc metamethod
        lua_pushcfunction(L, (IEnumerator_Quaternion__gc));
        lua_setfield(L, -2, "__gc");

        // __index metamethod
        lua_pushcfunction(L, (IEnumerator_Quaternion__index));
        lua_setfield(L, -2, "__index");

        // __newindex metamethod
        lua_pushcfunction(L, (IEnumerator_Quaternion__newindex));
        lua_setfield(L, -2, "__newindex");

        // __tostring metamethod
        lua_pushcfunction(L, (IEnumerator_Quaternion__tostring));
        lua_setfield(L, -2, "__tostring");

        lua_pop(L, 1);

        // Create type table for IEnumerator_Quaternion
        lua_newtable(L);

        // Constructor: new()
        lua_pushcfunction(L, (IEnumerator_Quaternion_new));
        lua_setfield(L, -2, "new");

        lua_setglobal(L, "IEnumerator_Quaternion");
    }

    private static int IEnumerator_Quaternion__gc(lua_State L)
    {
        ...
        if (ptr != 0)
        {
            ...
            {
                var id = *(int*)ptr;
                RemoveObject<System.Collections.Generic.IEnumerator<Stride.Core.Mathematics.Quaternion>>(id);
            }
        }
        return 0;
    }

    private static int IEnumerator_Quaternion__index(lua_State L)
    {
        var obj = GetObjectFromStack<System.Collections.Generic.IEnumerator<Stride.Core.Mathematics.Quaternion>>(L, 1);
    ...
    private static int IEnumerator_Quaternion__newindex(lua_State L)
    {
        var obj = GetObjectFromStack<System.Collections.Generic.IEnumerator<Stride.Core.Mathematics.Quaternion>>(L, 1);
    ...
    private static int IEnumerator_Quaternion__tostring(lua_State L)
    {
        var obj = GetObjectFromStack<System.Collections.Generic.IEnumerator<Stride.Core.Mathematics.Quaternion>>(L, 1);
    ...
    private static int IEnumerator_Quaternion_new(lua_State L)
    {
