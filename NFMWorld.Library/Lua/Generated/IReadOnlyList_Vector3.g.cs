...
public partial class LuaBindings
{
    ...
    private static void Register_IReadOnlyList_Vector3(lua_State L)
    {
        ...
        // __gc metamethod
        lua_pushcfunction(L, (IReadOnlyList_Vector3__gc));
        lua_setfield(L, -2, "__gc");

        // __index metamethod
        lua_pushcfunction(L, (IReadOnlyList_Vector3__index));
        lua_setfield(L, -2, "__index");

        // __newindex metamethod
        lua_pushcfunction(L, (IReadOnlyList_Vector3__newindex));
        lua_setfield(L, -2, "__newindex");

        // __tostring metamethod
        lua_pushcfunction(L, (IReadOnlyList_Vector3__tostring));
        lua_setfield(L, -2, "__tostring");

        lua_pop(L, 1);

        // Create type table for IReadOnlyList_Vector3
        lua_newtable(L);

        // Constructor: new()
        lua_pushcfunction(L, (IReadOnlyList_Vector3_new));
        lua_setfield(L, -2, "new");

        lua_setglobal(L, "IReadOnlyList_Vector3");
    }

    private static int IReadOnlyList_Vector3__gc(lua_State L)
    {
    ...
    private static int IReadOnlyList_Vector3_new(lua_State L)
    {
    ...
    private static int IReadOnlyList_Vector3_method_getEnumerator(lua_State L)
    {
