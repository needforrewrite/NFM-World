...
public unsafe partial class LuaBindings
{
    ...
    {
        RegisterMetatable<nfm_world_library.mad.rad.Rad3dBoxDef[]>("MT_Rad3dBoxDefArray");
        ...
        // Create type table for ArrayOfRad3dBoxDef
        lua_newtable(L);
    ...
    private static int Rad3dBoxDefArray__index(lua_State L)
    {
        ...
        if (lua_type(L, 2) == LUA_TNUMBER)
        {
            ...
            {
                var element = (obj as nfm_world_library.mad.rad.Rad3dBoxDef[])![index];
                PushValue(L, element);
                return 1;
            }
            lua_pushnil(L);
        ...
        {
            case "length":
                PushValue(L, ((nfm_world_library.mad.rad.Rad3dBoxDef[])obj).Length);
                return 1;
            case "longLength":
                PushValue(L, ((nfm_world_library.mad.rad.Rad3dBoxDef[])obj).LongLength);
                return 1;
            case "rank":
                PushValue(L, ((nfm_world_library.mad.rad.Rad3dBoxDef[])obj).Rank);
                return 1;
            case "syncRoot":
                PushValue(L, ((nfm_world_library.mad.rad.Rad3dBoxDef[])obj).SyncRoot);
                return 1;
            case "isReadOnly":
                PushValue(L, ((nfm_world_library.mad.rad.Rad3dBoxDef[])obj).IsReadOnly);
                return 1;
            case "isFixedSize":
                PushValue(L, ((nfm_world_library.mad.rad.Rad3dBoxDef[])obj).IsFixedSize);
                return 1;
            case "isSynchronized":
                PushValue(L, ((nfm_world_library.mad.rad.Rad3dBoxDef[])obj).IsSynchronized);
                return 1;
            case "count":
    ...
    private static int Rad3dBoxDefArray__newindex(lua_State L)
    {
        ...
        if (lua_type(L, 2) == LUA_TNUMBER)
        {
            ...
            if (index >= 0 && index < (obj as System.Array)!.Length)
            {
                ...
                (obj as nfm_world_library.mad.rad.Rad3dBoxDef[])![index] = value;
            }
            return 0;
        }
    ...
    private static int Rad3dBoxDefArray_new(lua_State L)
    {
        ...
        var array = new nfm_world_library.mad.rad.Rad3dBoxDef[dim0];
        PushObject(L, array, "MT_Rad3dBoxDefArray");
        return 1;
    }
