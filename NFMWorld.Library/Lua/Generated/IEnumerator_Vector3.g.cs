...
public partial class LuaBindings
{
    ...
    private static void Register_IEnumerator_Vector3(lua_State L)
    {
        ...
        // __gc metamethod
        lua_pushcfunction(L, (IEnumerator_Vector3__gc));
        lua_setfield(L, -2, "__gc");

        // __index metamethod
        lua_pushcfunction(L, (IEnumerator_Vector3__index));
        lua_setfield(L, -2, "__index");

        // __newindex metamethod
        lua_pushcfunction(L, (IEnumerator_Vector3__newindex));
        lua_setfield(L, -2, "__newindex");

        // __tostring metamethod
        lua_pushcfunction(L, (IEnumerator_Vector3__tostring));
        lua_setfield(L, -2, "__tostring");

        lua_pop(L, 1);

        // Create type table for IEnumerator_Vector3
        lua_newtable(L);

        // Constructor: new()
        lua_pushcfunction(L, (IEnumerator_Vector3_new));
        lua_setfield(L, -2, "new");

        lua_setglobal(L, "IEnumerator_Vector3");
    }

    private static int IEnumerator_Vector3__gc(lua_State L)
    {
    ...
    private static int IEnumerator_Vector3__index(lua_State L)
    {
        ...
        switch (key)
        {
            case "current":
                ...
                return 1;
            case "dispose":
                lua_pushcfunction(L, (IEnumerator_Vector3_method_dispose));
                return 1;
            case "moveNext":
                lua_pushcfunction(L, (IEnumerator_Vector3_method_moveNext));
                return 1;
            case "reset":
                lua_pushcfunction(L, (IEnumerator_Vector3_method_reset));
                return 1;
            default:
                lua_pushnil(L);
                return 1;
    ...
    private static int IEnumerator_Vector3_new(lua_State L)
    {
    ...
    private static int IEnumerator_Vector3_method_dispose(lua_State L)
    {
    ...
    private static int IEnumerator_Vector3_method_moveNext(lua_State L)
    {
        var argCount = lua_gettop(L) - 1; // First arg is self
    ...
    private static int IEnumerator_Vector3_method_reset(lua_State L)
    {
        var argCount = lua_gettop(L) - 1; // First arg is self
