            ...
            case "current":
                {
                    ...
                    if (ptr != 0)
                    {
                        unsafe
                        {
                            ...
                            PushStructWithParent(L, obj.Current, "MT_Vector4", parentId, static (obj, value) => { System.Diagnostics.Debug.WriteLine($"Attempted to assign value of struct {obj} ({obj.GetType()}) member 'Current' to {value} but the field is read-only. Nothing will be set."); });
                        }
                    }
                }
                return 1;
