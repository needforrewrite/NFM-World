...
public partial class LuaBindings
{
    ...
    {
        RegisterMetatable<System.Collections.ObjectModel.ReadOnlyCollection<nfm_world_library.backend.BackendGameObject>>("MT_ReadOnlyCollection_BackendGameObject");
        ...
        // Create type table for ReadOnlyCollection_BackendGameObject
        lua_newtable(L);
    ...
    private static int ReadOnlyCollection_BackendGameObject__index(lua_State L)
    {
        ...
        {
            case "count":
                PushValue(L, ((System.Collections.ObjectModel.ReadOnlyCollection<nfm_world_library.backend.BackendGameObject>)obj).Count);
                return 1;
            case "isReadOnly":
            ...
            case "isSynchronized":
                ...
                return 1;
            case "contains":
                lua_pushcfunction(L, (ReadOnlyCollection_BackendGameObject_method_contains));
                return 1;
            case "copyTo":
                lua_pushcfunction(L, (ReadOnlyCollection_BackendGameObject_method_copyTo));
                return 1;
            case "getEnumerator":
                lua_pushcfunction(L, (ReadOnlyCollection_BackendGameObject_method_getEnumerator));
                return 1;
            case "indexOf":
                lua_pushcfunction(L, (ReadOnlyCollection_BackendGameObject_method_indexOf));
                return 1;
            case "getType":
    ...
    private static int ReadOnlyCollection_BackendGameObject_new(lua_State L)
    {
        ...
        if (argCount == 1)
        {
            var arg0 = ToObject<System.Collections.Generic.IList<nfm_world_library.backend.BackendGameObject>>(L, 1)!;
            try
            {
                var obj = new System.Collections.ObjectModel.ReadOnlyCollection<nfm_world_library.backend.BackendGameObject>(arg0);
                PushObject(L, obj, "MT_ReadOnlyCollection_BackendGameObject");
                return 1;
            }
    ...
    private static int ReadOnlyCollection_BackendGameObject_method_contains(lua_State L)
    {
        var argCount = lua_gettop(L) - 1; // First arg is self

        var self = GetObjectFromStack<System.Collections.ObjectModel.ReadOnlyCollection<nfm_world_library.backend.BackendGameObject>>(L, 1);
        if (self == null)
        {
        ...
        if (argCount == 1)
        {
            ...
            try
            {
                var result = ((System.Collections.ObjectModel.ReadOnlyCollection<nfm_world_library.backend.BackendGameObject>)self).Contains(arg0);
                PushValue(L, result);
                return 1;
            }
            catch (System.Exception ex)
    ...
    private static int ReadOnlyCollection_BackendGameObject_method_copyTo(lua_State L)
    {
        var argCount = lua_gettop(L) - 1; // First arg is self
        ...
        if (argCount == 2)
        {
            ...
            try
            {
                ((System.Collections.ObjectModel.ReadOnlyCollection<nfm_world_library.backend.BackendGameObject>)self).CopyTo(arg0, arg1);
                return 0;
            }
            catch (System.Exception ex)
            {
    ...
    private static int ReadOnlyCollection_BackendGameObject_method_getEnumerator(lua_State L)
    {
        var argCount = lua_gettop(L) - 1; // First arg is self
        ...
        if (argCount == 0)
        {
            try
            {
                var result = ((System.Collections.ObjectModel.ReadOnlyCollection<nfm_world_library.backend.BackendGameObject>)self).GetEnumerator();
                PushValue(L, result);
                return 1;
            }
            catch (System.Exception ex)
    ...
    private static int ReadOnlyCollection_BackendGameObject_method_indexOf(lua_State L)
    {
        var argCount = lua_gettop(L) - 1; // First arg is self
        ...
        if (argCount == 1)
        {
            ...
            try
            {
                var result = ((System.Collections.ObjectModel.ReadOnlyCollection<nfm_world_library.backend.BackendGameObject>)self).IndexOf(arg0);
                PushValue(L, result);
                return 1;
            }
            catch (System.Exception ex)
    ...
    private static int ReadOnlyCollection_BackendGameObject_method_getType(lua_State L)
    {
        ...
        if (argCount == 0)
        {
            try
            {
                var result = ((System.Collections.ObjectModel.ReadOnlyCollection<nfm_world_library.backend.BackendGameObject>)self).GetType();
                PushValue(L, result);
                return 1;
            }
            catch (System.Exception ex)
    ...
    private static int ReadOnlyCollection_BackendGameObject_method_toString(lua_State L)
    {
        ...
        if (argCount == 0)
        {
            try
            {
                var result = ((System.Collections.ObjectModel.ReadOnlyCollection<nfm_world_library.backend.BackendGameObject>)self).ToString();
                PushValue(L, result);
                return 1;
            }
            catch (System.Exception ex)
    ...
    private static int ReadOnlyCollection_BackendGameObject_method_equals(lua_State L)
    {
        ...
        if (argCount == 1)
        {
            ...
            try
            {
                var result = ((System.Collections.ObjectModel.ReadOnlyCollection<nfm_world_library.backend.BackendGameObject>)self).Equals(arg0);
                PushValue(L, result);
                return 1;
            }
            catch (System.Exception ex)
    ...
    private static int ReadOnlyCollection_BackendGameObject_method_getHashCode(lua_State L)
    {
        ...
        if (argCount == 0)
        {
            try
            {
                var result = ((System.Collections.ObjectModel.ReadOnlyCollection<nfm_world_library.backend.BackendGameObject>)self).GetHashCode();
                PushValue(L, result);
                return 1;
            }
            catch (System.Exception ex)
    ...
    private static int ReadOnlyCollection_BackendGameObject_type__index(lua_State L)
    {
        ...
        {
            case "empty":
                PushValue(L, System.Collections.ObjectModel.ReadOnlyCollection<nfm_world_library.backend.BackendGameObject>.Empty);
                return 1;
            default:
                lua_rawget(L, 1);
                return 1;
