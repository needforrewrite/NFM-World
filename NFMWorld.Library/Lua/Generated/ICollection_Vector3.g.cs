...
public partial class LuaBindings
{
    ...
    private static void Register_ICollection_Vector3(lua_State L)
    {
        ...
        // __gc metamethod
        lua_pushcfunction(L, (ICollection_Vector3__gc));
        lua_setfield(L, -2, "__gc");

        // __index metamethod
        lua_pushcfunction(L, (ICollection_Vector3__index));
        lua_setfield(L, -2, "__index");

        // __newindex metamethod
        lua_pushcfunction(L, (ICollection_Vector3__newindex));
        lua_setfield(L, -2, "__newindex");

        // __tostring metamethod
        lua_pushcfunction(L, (ICollection_Vector3__tostring));
        lua_setfield(L, -2, "__tostring");

        lua_pop(L, 1);

        // Create type table for ICollection_Vector3
        lua_newtable(L);

        // Constructor: new()
        lua_pushcfunction(L, (ICollection_Vector3_new));
        lua_setfield(L, -2, "new");

        lua_setglobal(L, "ICollection_Vector3");
    }

    private static int ICollection_Vector3__gc(lua_State L)
    {
    ...
    private static int ICollection_Vector3__index(lua_State L)
    {
        ...
        switch (key)
        {
            ...
            case "add":
                ...
                return 1;
            case "clear":
                lua_pushcfunction(L, (ICollection_Vector3_method_clear));
                return 1;
            case "contains":
                lua_pushcfunction(L, (ICollection_Vector3_method_contains));
                return 1;
            case "copyTo":
                lua_pushcfunction(L, (ICollection_Vector3_method_copyTo));
                return 1;
            case "remove":
                lua_pushcfunction(L, (ICollection_Vector3_method_remove));
                return 1;
            case "getEnumerator":
                lua_pushcfunction(L, (ICollection_Vector3_method_getEnumerator));
                return 1;
            default:
                lua_pushnil(L);
                return 1;
    ...
    private static int ICollection_Vector3_new(lua_State L)
    {
    ...
    private static int ICollection_Vector3_method_add(lua_State L)
    {
    ...
    private static int ICollection_Vector3_method_clear(lua_State L)
    {
        var argCount = lua_gettop(L) - 1; // First arg is self
    ...
    private static int ICollection_Vector3_method_contains(lua_State L)
    {
        var argCount = lua_gettop(L) - 1; // First arg is self
    ...
    private static int ICollection_Vector3_method_copyTo(lua_State L)
    {
        var argCount = lua_gettop(L) - 1; // First arg is self
    ...
    private static int ICollection_Vector3_method_remove(lua_State L)
    {
        var argCount = lua_gettop(L) - 1; // First arg is self
    ...
    private static int ICollection_Vector3_method_getEnumerator(lua_State L)
    {
        var argCount = lua_gettop(L) - 1; // First arg is self
