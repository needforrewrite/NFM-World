...
public partial class LuaBindings
{
    ...
    private static int DateOnly_method_toDateTime(lua_State L)
    {
        ...
        if (argCount == 2)
        {
            ...
            try
            {
                var result = self.ToDateTime(arg0, arg1);
                UpdateStruct(L, 1, self);
                PushValue(L, result);
                return 1;
            }
    ...
    private static int DateOnly_method_compareTo(lua_State L)
    {
        ...
        if (argCount == 1)
        {
            ...
            // Try overload 0: CompareTo(System.DateOnly)
            {
                int score = 0;
                int score0 = ScoreParameterCompatibility<System.DateOnly>(L, 2);
                if (score0 < 0) goto next0;
                else score += score0;
                if (score > bestScore)
                {
    ...
    private static int DateOnly_method_equals(lua_State L)
    {
        ...
        if (argCount == 1)
        {
            ...
            // Try overload 0: Equals(System.DateOnly)
            {
                int score = 0;
                int score0 = ScoreParameterCompatibility<System.DateOnly>(L, 2);
                if (score0 < 0) goto next0;
