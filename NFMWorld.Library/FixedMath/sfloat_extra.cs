...
{
    public static fix64 Pi => new(FixedMathSharp.FixedMath.PI);
    public static fix64 HalfPi => new(FixedMathSharp.FixedMath.PiOver2);
    public static fix64 TwoPi => new(FixedMathSharp.FixedMath.TwoPI);
    public static fix64 PiOver4 => new(FixedMathSharp.FixedMath.PiOver4);
    
    public static fix64 DegToRad => new(FixedMathSharp.FixedMath.Deg2Rad);
    public static fix64 RadToDeg => new(FixedMathSharp.FixedMath.Rad2Deg);
    ...
    public static fix64 Sqrt(fix64 f) => new(FixedMathSharp.FixedMath.Sqrt(f.Value));

    public static fix64 Acos(fix64 f) => new(FixedMathSharp.FixedMath.Acos(f.Value));

    public static fix64 Atan2(fix64 a, fix64 b) => new(FixedMathSharp.FixedMath.Atan2(a.Value, b.Value));

    public static fix64 Round(fix64 f) => new(FixedMathSharp.FixedMath.Round(f.Value));

    public static fix64 Sin(fix64 f) => new(FixedMathSharp.FixedMath.Sin(f.Value));

    public static fix64 Cos(fix64 f) => new(FixedMathSharp.FixedMath.Cos(f.Value));

    public static fix64 Floor(fix64 f) => new(FixedMathSharp.FixedMath.Floor(f.Value));

    public static fix64 Ceiling(fix64 f) => new(FixedMathSharp.FixedMath.Ceiling(f.Value));
