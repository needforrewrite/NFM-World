...
namespace LuaJIT
{
    ...
    public static unsafe partial class Methods
    {
        ...
        [DllImport("lua515", CallingConvention = CallingConvention.Cdecl)]
        ...
        [DllImport("lua515", CallingConvention = CallingConvention.Cdecl, EntryPoint = "lua_typename")]
        [SuppressGCTransition]
        [return: NativeTypeName("const char *")]
        ...
        [DllImport("lua515", CallingConvention = CallingConvention.Cdecl, EntryPoint = "lua_getlocal")]
        [SuppressGCTransition]
        [return: NativeTypeName("const char *")]
        public static extern sbyte* _lua_getlocal(lua_State L, [NativeTypeName("const lua_Debug *")] lua_Debug* ar, int n);

        [DllImport("lua515", CallingConvention = CallingConvention.Cdecl, EntryPoint = "lua_setlocal")]
        [SuppressGCTransition]
        [return: NativeTypeName("const char *")]
        public static extern sbyte* _lua_setlocal(lua_State L, [NativeTypeName("const lua_Debug *")] lua_Debug* ar, int n);

        [DllImport("lua515", CallingConvention = CallingConvention.Cdecl, EntryPoint = "lua_getupvalue")]
        [SuppressGCTransition]
        [return: NativeTypeName("const char *")]
        public static extern sbyte* _lua_getupvalue(lua_State L, int funcindex, int n);

        [DllImport("lua515", CallingConvention = CallingConvention.Cdecl, EntryPoint = "lua_setupvalue")]
        [SuppressGCTransition]
        [return: NativeTypeName("const char *")]
        ...
        [DllImport("lua515", CallingConvention = CallingConvention.Cdecl, EntryPoint = "lua_version")]
        [SuppressGCTransition]
